---------------------------------------------------------------
-- @file	stgE10_config.lua
-- @author	Miura Yoshitaka <Miura_Yoshitaka@sega.co.jp>
-- @brief	stgE10 の設定ファイル 2010/04/03
---------------------------------------------------------------
 ...
 -- ライト
	{
		...
		params = {
			...
			lfield_params = {
				{
					index = 1,
					diffuse_color = { 200, 190, 210 },
					gloss = 16.0,
					sky_color = { 180, 160, 210, },
					ground_color = { 70, 50, 100, },
				},
				{
					index = 2,
					diffuse_color = { 75, 65, 95},
					gloss = 16.0,
