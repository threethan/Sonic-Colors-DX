...
zone_table = {
   ...
   {
	  index = 1,
	  missions = { "stg210", "stg230", "stg220", "stg240", "stg250", "stg260", "stg290", },
   },
   -- zone3
   {
	  index = 2,
	  missions = { "stg310", "stg320", "stg330", "stg340", "stg350", "stg360", "stg390", },
   },
   -- zone4
   {
	  index = 3,
	  missions = { "stg410", "stg430", "stg420", "stg440", "stg450", "stg460", "stg490", },
   },
   -- zone5
   {
	  index = 4,
	  missions = { "stg510", "stg530", "stg510", "stg530", "stg560", "stg520", "stg590", },
   },
   -- zone6
   {
	  index = 5,
	  missions = { "stg610", "stg630", "stg620", "stg640", "stg650", "stg660", "stg670", },
   },
   -- zone7
   {
	  index = 6,
